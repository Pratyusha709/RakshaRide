...
3. Starts the journey  
4. System tracks location in real-time  
5. Alerts are sent if route deviation is detected  
6. User can press panic button or use voice command  
7. Trusted contacts receive emergency alerts  
8. Safe completion notification is sent at journey end  
...
- Emergency support during unsafe situations  
